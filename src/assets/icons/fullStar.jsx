function FullStar({ empty }){

    return(
        <svg xmlns="http://www.w3.org/2000/svg" className={`star-icon ${empty ? 'empty' : ''}`} viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet">
