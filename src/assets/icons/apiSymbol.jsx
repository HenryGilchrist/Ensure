function ApiIcon(){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="api-icon" viewBox="0 0 48 48" fill="none">
            <path d="M18 23.9372V10C18 6.68629 20.6863 4 24 4C27.3137 4 30 6.68629 30 10V12.0057" />
            <path d="M30 24.0035V38C30 41.3137 27.3137 44 24 44C20.6863 44 18 41.3137 18 38V35.97" />
